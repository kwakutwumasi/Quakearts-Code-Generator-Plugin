...
public class ResourceManager extends SWTResourceManager {
		...
		if (result == null) {
			...
			CompositeImageDescriptor compositImageDesc = new CompositeImageDescriptor() {
				...
				protected void drawCompositeImage(int width, int height) {
					drawImage((zoom)->{
						return zoom==100?baseImage.getImageData():null;
					}, 0, 0);
					if (corner == TOP_LEFT) {
						drawImage((zoom)->{
							return zoom==100?decorator.getImageData():null;
						}, 0, 0);
	...
	/**
	 * Returns an {@link Image} based on a {@link Bundle} and resources entry path.
	 * 
	 * @param symbolicName
	 *            the symbolic name of the {@link Bundle}.
	 * @param path
	 *            the path of the resources entry.
	 * @return the {@link Image} stored in the file at the specified path.
	 */
	...
	/**
	 * Returns an {@link ImageDescriptor} based on a {@link Bundle} and resources entry path.
	 * 
	 * @param symbolicName
	 *            the symbolic name of the {@link Bundle}.
	 * @param path
	 *            the path of the resources entry.
	 * @return the {@link ImageDescriptor} based on a {@link Bundle} and resources entry path.
	 */
	...
	/**
	 * Returns an {@link URL} based on a {@link Bundle} and resources entry path.
	 */
